<?php
// تم تصحيح الاخطاء من قبل ميدو 🎗️
/*
بسم الله الرحمن الرحيم
*/
error_reporting(-1);
ob_start();
$API_KEY = "6591932058:AAHmn7eJWbaaeVyVZk--BiSADOm_qyqIzXw"; //توكنك
$admin = 6877747792; //ايديك
$c = "@Raadv2_1"; //قناتك
...
$m = date('y/m/d h:i');
$d = date('D');
$ch = "https://t.me/Raadv2_1".str_replace('@Raadv2_1',null,$c);
...
$bt = str_replace(['yes','no'],['مفعل 🎗️','معطل ⚠'],$sudo_json['sudo']['bot']);
bot('sendmessage',[
'chat_id'=>$chat_id,
'parse_mode'=>"MarkDown",
'text'=>"*• البوت $bt*",
...
🎗️¦ `#tag`  لعرض اسم المشترك مع تاك
🎗️¦ `#name`  لعرض اسم المشترك
🎗️¦ `#id`  لعرض أيدي المشترك
🎗️¦ `@#user`  لعرض يوزر المشترك",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
[['text'=>"رجوع 🔙"]],
...
$idbot = 618075591; //ايدي بوتك
$seh = str_replace("ستدعي ","",$text);
if($text == "ستدعي $seh" ){
bot('sendmessage',[
'chat_id' => $chat_id,
'text' => "تعال يالهطف '.@$seh.' هذا يريدك 👀👉 '.@$username.'",
'reply_to_message_id'=>$message->message_id,
]);}

if($re and $text == "ستدعي" and $from_id != $re_id and $re_id != $idbot){
bot('sendmessage',[
'chat_id' => $chat_id,
'text' => " تعال يالهطف '.@$re_user.' يريدونك بالكروب 💖🐯",
'reply_to_message_id'=>$re,
]);}

if($re and $text == "ستدعي" and $from_id == $re_id ){
bot('sendmessage',[
'chat_id' => $chat_id,
'text' => " في اهبل هنا يريد يستدعي لنفسه 😂 
اسمه [$name](t.me/$username)
",
'reply_to_message_id'=>$message->message_id,
...
if($re and $text == "ستدعي" and $re_id == $idbot ){
bot('sendmessage',[
'chat_id' => $chat_id,
'text' => " لك حمار منو يقدر يستدعي لنفسه 😑😒",
'reply_to_message_id'=>$message->message_id,
]);}
...
$dev_a = array('منور حياتي 😻','يهلا بالاسد 💝','نورت المجموعة😒💔');
...
$txt = str_replace("رعد معلومات عن ","",$text);
if($text == "رعد معلومات عن $txt"){
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"
...
'chat_id'=>$chat_id,
'text'=>'
• حسناً عزيزي قم بإرسال أيدي أو معرف الشخص الذي تريد رفعه مطور بالبوت 🎗️',
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
[['text'=>"رجوع 🔙"]],
...
'chat_id'=>$chat_id,
'text'=>'
• حسناً عزيزي قم بإرسال أيدي أو معرف الشخص الذي تريد حظره عام من المجموعات 🎗️',
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
[['text'=>"رجوع 🔙"]],
...
* تم الغاء تفعيل المجموعة بنجاح 🎗️*",
'reply_to_message_id'=>$message_id,
]);
...
*حسناً قم بإرسال كلمة الرد لحذفها 🎗️*",
'reply_to_message_id'=>$message_id,
]);
...
'chat_id'=>$chat_id,
'parse_mode'=>"MarkDown",
'text'=>"*تم تعيين عدد مرات التكرار $nt بنجاح 🎗️*
...
$ldev_a = array ('لا هذا يقول الحق 👻','لا هذا كذاب 😂🎺','ليش احسك تكذب🤔');
$ailnoor = array_rand($ldev_a, 1);

 $me = $message->reply_to_message; 
$ldev_i = $me->message_id;
$re = $update->message->reply_to_message;
if($text == "رعد رايك في كلامو"and $re){
    bot('sendmessage',[
    'chat_id'=>$chat_id,
    'text'=>"🤷🏿‍♂️ إنتظر راح اعرف اذا يكذب🧠",
...
'reply_to_message_id'=>$ldev_i,
  ...
  if($text == "/start"){
$url = "https://dev-amazinalovi.pantheonsite.io/IMG_20240119_192645_044.jpg"; // هنا رابط
bot('sendPhoto',['chat_id' =>$chat_id,"photo"=>$url,'caption' =>"*⌔︙أهلآ بك في بوت رعد
⌔︙اختصاص البوت حماية المجموعات
⌔︙لتفعيل البوت عليك اتباع مايلي ...
⌔︙اضف البوت الى مجموعتك
⌔︙ارفعه ادمن {مشرف}
...
if(strpos($text,"واش رايك فيه")!== false){
$armof = array("🤬لك هذا حبي😂","قمر  🙃🙃هذا","احبه 😍😋","اكرهه","اكبر مخادع هذا😂😃",);
...
•------------» $channel «------------•
م1 •🎲 *لعرض اوامر البحث*
م2 •🎗️ *لعرض اوامر القفل والفتح*
م3 •🎳 *لعرض اوامر الرفع والتنزيل*
م4 •🛎️ *لعرض اوامر الحماية*
...
*
🎗️ ¦ سورة: اسم السورة ~ لارسال السورة على شكل ملف mp3
🎗️ ¦ اية: ما تذكره من اية ~ للبحث عن آية
🎗️ ¦ اية: ما تذكره من اية ~ للبحث عن آية
🎗️ ¦ للبحث الشامل في القرأن ارسل كلمة بحث
🎗️ ¦ للبحث في التفاسير ارسل
🎗️ ¦ الميسر
🎗️ ¦ الجلالين
🎗️ ¦ صفحة رقم الصفحة ~ لإرسال صورة الصفحة في القرآن الكريم
🎗️ ¦ حديث: ما تذكره من الحديث ~ للبحث عن الحديث
🎗️ ¦ أحاديث: وما تذكره من الحديث للبحث في مجموعة الأحاديث
🎗️ ¦ وللبحث عن حديث برقم الحديث في الكتب التالية 
🎗️ ¦ صحيح البخاري
🎗️ ¦ صحيح مسلم
🎗️ ¦ مسند أحمد
🎗️ ¦ موطأ مالك
...
🎗️ ¦ موطأ مالك 100
🎗️ ¦ سنن الدارمي 100
🎗️ ¦ مقاطع قصيرة ~ لإرسال مقطع قصير
*
...
'parse_mode'=>"MarkDown",
'text'=>"
*تم تفعيل الايدي بالصورة بنجاح 🎗️*
...
*في قائمة الحماية 🎁*
•-----------» $channel «-----------•
🎗️¦ `تقييد` ~ الغاء التقييد 
🎗️¦ `كتم` ~ `الغاء الكتم` 
🎗️¦ `حظر` ~ `الغاء الحظر` 
🎗️¦ `طرد` ~ *لا يوجد الغاء طرد* 
•-----------» $channel «-----------•
🎗️¦ `المقيدين` •🎲 *لعرض المقيدين *
🎗️¦ `المكتومين` •🎲 *لعرض المكتومين *
🎗️¦ `المطرودين` •🎲 *لعرض المطردوين *
🎗️¦ `المحظورين` •🎲 *لعرض المطردوين *
•-----------» $channel «-----------•
🎗️¦ `مسح المقيدين` •⊱ 🎁لمسح المقيدين *
🎗️¦ `مسح المطرودين` •🎁 *لمسح المطرودين *
🎗️¦ `مسح المكتومين` • 🎁لمسح المطردوين *
🎗️¦ `مسح المحظورين` •🎁 *لمسح المطردوين *

•-----------» $channel «-----------•
🎗️¦ `تاك` ~ *لعمل تاك للاعضاء المتفاعلين *
🎗️¦ `مسح الميديا` ~ *لمسح الميديا في الكروب *
•-----------» $channel «-----------•
...
if(preg_match('/^رعد كتاب (.*)/',$text)){
preg_match('/^رعد كتاب (.*)/',$text,$matches);
$search = $matches[1];
...
if(preg_match('/^رعد سورة (.*)$/',$text,$match)){
...
if(preg_match('/^رعد حديث (.*)/',$text,$match)){
...
if(preg_match("/رعد صفحة ([\d]*)/",$text,$count)){
bot('SendPhoto',[
'chat_id'=>$chat_id,
...
'title'=>"رعد الصفحة  ".$pagee,
'parse_mode'=>"MarkDown",
'caption'=>"صفحة رقم *$count[1]* من القرآن الكريم 🌿",
'reply_to_message_id'=>$message_id,
]);
}
if($text == "رعد مقاطع قصيرة"){
$rand_id = rand(2,100);
...
if(preg_match('/^رعد اية (.*)/',$text,$match)){
...
✳️ ┇ [حساب المطور YL](http://telegram.me/@YanGv20)
✳️ ┇ [قناة المطور](http://telegram.me/YanGv20)
✳️ ┇ [مجموعتي](https://t.me/YanGv20)
✳️ ┇ [](https://youtube.com/channel/رابط قناتي هنا)
",
]);
} 
